...
export default function HipHopBasicsPage() {
  const steps = hipHopBasics.steps;
    ...
    <RequireAuth>
      <main className="min-h-screen bg-deep-purple">
        <div className="mx-auto max-w-2xl px-6 pb-28 pt-10">
          ...
          <ModuleHeader module={hipHopBasics} />

          <StepsListWithProgress moduleId={hipHopBasics.id} steps={steps} />
        </div>
        ...
        >
          <div className="mx-auto max-w-2xl">
            <Link
              href={`/lezioni/${hipHopBasics.id}/step/1`}
